package co.develhope.introduction._5;
...
public class EsercizioString {
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        // Change these
        String firstName = "Nicolo'";
        String middleName = "Andrea";
        String lastName = "Ferri";
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "true" + 2; // <--- Edit this line
